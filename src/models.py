class Cell:
    ...
    def _init_(self, voltage=3.7, capacity=2.5, internal_resistance=0.05, temp=25):
...
class FaultMonitor:
    ...
    def _init_(self, overvoltage=4.2, undervoltage=3.5, overtemp=30, undertemp=0, imbalance_threshold=0.05):
